...
/* Объявления и выражения присванивания для типа Objects (так и не понял, нужны ли?)
let obj_1: { num: number; str: string; bool: boolean; null: null; sym: symbol; any: any; } 
= { num: 42.66, str: "Hello, World!", bool: true, null: null, sym: Symbol(''), any: ''};

var obj_2: { num: number; str: string; bool: boolean; null: null; sym: symbol; any: any; } 
= { num: 42.66, str: "Hello, World!", bool: true, null: null, sym: Symbol(''), any: ''};

const obj_3: { num: number; str: string; bool: boolean; null: null; sym: symbol; any: any; } 
= { num: 42.66, str: "Hello, World!", bool: true, null: null, sym: Symbol(''), any: ''};

let obj_4 = { num: 42.66, str: "Hello, World!", bool: true, null: null, sym: Symbol(''), any: ''};
var obj_5 = { num: 42.66, str: "Hello, World!", bool: true, null: null, sym: Symbol(''), any: ''};
const obj_6 = { num: 42.66, str: "Hello, World!", bool: true, null: null, sym: Symbol(''), any: ''}; */